...
import { useCacheDestory } from 'react-keepalive-component'
        ...
        <Row gutter={16}>
          <Col span={12}>
            <Card bordered={false} className='card-item'>
              <Button type="primary" onClick={()=> destory('FormDemo1') }  >清除表单页面缓存</Button>&emsp;
...
export default function (props){
  ...
  return <ButtonDemo {...props} destory={destory} />
}