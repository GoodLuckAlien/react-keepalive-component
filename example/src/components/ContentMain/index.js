...
import { KeepaliveItem } from 'react-keepalive-component'
    ...
    return (
      <div style={{padding: 16, position: 'relative'}}>
        <Switch>
          ...
          <PrivateRoute exact path='/home/entry/form/basic-form' >
              <KeepaliveItem cacheId="FormDemo1" ><FormDemo1/></KeepaliveItem>
          </PrivateRoute>
